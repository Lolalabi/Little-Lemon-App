        ...
        <VStack alignItems="flex-start" justifyContent="space-evenly">
          ...
          <HStack>
            <Badge
              ...
              bg="#f4ce14"
            >
              We have outdoor and courtyard seating!
            </Badge>
            <Badge variant="subtle" ml="2" rounded="3px" bg="#f4ce14">
              <a
                href="https://www.flaticon.com/free-icons/patio"
                title="patio icons"
              >
                <Image src={patio} boxSize="27px" />
              </a>
            </Badge>
          </HStack>
        </VStack>
