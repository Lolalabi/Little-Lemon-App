...
import MarioAdrian from "../images/MarioAdrian1.jpg";
        ...
        <Flex mr={40} gap={4} justifyContent="space-evenly">
          <VStack spacing={4} alignItems="flex-start" justifyContent="center">
            ...
            >
              ...
              <br />
              who moved to the United States to pursue their
              <br />
            ...
            >
              ...
              <br /> and cuisines are inspired by Italian, Greek, and Turkish
              culture.
            </Text>
          </VStack>
          <Box
          ...
          >
            <Image
              ...
              alignSelf="center"
              justifySelf="center"
              alt="Mario and Adrian image"
              boxSize={["100px", "120px", "290px"]}
              borderRadius="10px"
            />
          </Box>
        </Flex>
